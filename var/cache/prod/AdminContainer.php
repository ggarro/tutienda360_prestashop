...
class AdminContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/var/www/html/tutienda360/modules/productcomments/src/Entity']);
        $d->addExcludePaths([0 => '/var/www/html/tutienda360/modules/productcomments/src/Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/var/www/html/tutienda360/src/PrestaShopBundle/Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('/var/www/html/tutienda360/var/cache/prod//doctrine/orm/Proxies');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/var/www/html/tutienda360/var/cache/prod//localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(${($_ = isset($this->services['prestashop.core.localization.cldr.cache.adapter']) ? $this->services['prestashop.core.localization.cldr.cache.adapter'] : ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/var/www/html/tutienda360/var/cache/prod//localization'))) && false ?: '_'});
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => '/var/www/html/tutienda360/app',
            'kernel.project_dir' => '/var/www/html/tutienda360',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/var/www/html/tutienda360/var/cache/prod/',
            ...
            'ps_cache_dir' => '/var/www/html/tutienda360/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/html/tutienda360/var/cache/prod//doctrine/orm/Proxies',
