...
Una vez actives la opción "%generate_rtl_label%", cualquier archivo específico RTL que hayas añadido al tema podría ser eliminado por la hoja de estilo creada.',
  ...
  'ShopThemeGlobal' => 
  array (
    '%copyright% %year% - Ecommerce software by %prestashop%' => '%copyright% %year% - Ecommerce software by GR Digital Solutions 
',
    'Latest From' => 'Lo último de',
    'Subscribe to our newsletter to get exclusive discounts and new theme launches right in your inbox.' => 'Suscríbase a nuestro boletín para obtener descuentos exclusivos y lanzamientos de nuevos temas directamente en su bandeja de entrada.',
    'Etrend' => 'Shalux Lighting',
    'Contact us' => 'Contáctenos',
    'Contact Us' => 'Contáctenos',
    'NewsLetter' => 'Boletín informativo',
    'Join us for get latest updates' => 'Únase a nosotros para obtener las últimas noticias y ofertas',
    ...
    'Search again what you are looking for' => 'Vuelve a buscar lo que buscas',
  ...
  array (
    ...
    'Product' => 'producto',
    'New' => 'Nuevos',
    'Showing %from%-%to% of %total% item(s)' => 'Showing %from%-%to% of %total% producto(s)',
    'Last time this product was added to a cart: %date_last_cart%' => 'La última vez que este producto se agregó a un carrito: %date_last_cart%',
    ...
    'List of products by supplier %s' => 'Lista de productos por supplier %s',
    ...
    'On sale' => 'En venta',
    'Search our catalog' => 'Busque en nuestro catalogo',
    'Search' => 'Buscar',
    'No RSS feed added' => 'No se agregó ninguna fuente RSS',
    'Last time this product was bought: %date_last_order%' => 'Última vez que compró este producto:% date_last_order%',
  ...
  array (
    ...
    'Please enter the email address you used to register. You will receive a temporary link to reset your password.' => 'Ingrese la dirección de correo electrónico que utilizó para registrarse. Recibirá un enlace temporal para restablecer su contraseña.',
    'View credit slip' => 'Ver comprobante de crédito',
    'Credit slip' => 'Deslizamiento de crédito',
    'Credit slips you have received after canceled orders.' => 'Boletas de crédito que ha recibido después de pedidos cancelados.',
    'Date issued' => 'Fecha de emisión',
    'Order' => 'Orden',
    'If the conditions of return listed above are not respected, we reserve the right to refuse your package and/or reimbursement.' => 'Si no se respetan las condiciones de devolución enumeradas anteriormente, nos reservamos el derecho a rechazar su paquete y / o reembolso.',
    ...
    'Please print out the [1]returns form[/1] and include it with your package.' => 'Imprima el [1] formulario de devolución [/ 1] e inclúyalo en su paquete.',
    'All merchandise must be returned in its original packaging and in its original state.' => 'Toda la mercancía debe devolverse en su embalaje original y en su estado original.',
    'Reminder' => 'Recordatorio',
    'List of items to be returned:' => 'Lista de artículos a devolver:',
    'The current status of your merchandise return is: [1] %status% [/1]' => 'El estado actual de la devolución de su mercancía es: [1]% status% [/ 1]',
    ...
    'Easier merchandise return' => 'Devolución de mercancía más fácil',
    'Fast and easy checkout' => 'Salida rápida y fácil',
    ...
    'No account? Create one here' => '¿No tienes cuenta? Crea uno aquí',
  ...
  array (
    ...
    'My Cart' => 'Mi Carrito',
    'There is %product_count% item in your cart.' => 'Hay %product_count% productos en su carrito.',
    'There are %products_count% items in your cart.' => 'Hay %products_count% productos en su carrito.',
    'Order items' => 'ordenar producto',
    ...
    'The selected address will be used both as your personal address (for invoice) and as your delivery address.' => 'La dirección seleccionada se utilizará como su dirección personal (para la factura) y como su dirección de entrega.',
  ...
  array (
    'Your report cannot be sent' => 'No se puede enviar su informe',
    ...
    'Report comment' => 'Informar comentario',
    'Your review appreciation cannot be sent' => 'No se puede enviar el agradecimiento por tu reseña',
    'Comments' => 'Comentarios',
    'Sorry, your abuse report cannot be sent.' => 'Lo sentimos, no se puede enviar tu informe de abuso.',
    'Sorry, your review appreciation cannot be sent.' => 'Lo sentimos, no se puede enviar el agradecimiento por tu reseña.',
    'Write your review' => 'Escribe tu reseña',
    'Report abuse' => 'Reportar abuso',
    'Read user reviews' => 'Leer reseñas de usuarios',
    'Your review cannot be sent' => 'No se puede enviar tu reseña',
    'Review sent' => 'Revisión enviada',
    ...
    'Your name' => 'Tu nombre',
    'Title' => 'Título',
    'Sorry, your review cannot be posted.' => 'Lo sentimos, su reseña no se puede publicar.',
    'No customer reviews for the moment.' => 'No hay ninguna opinión por el momento.',
    'Be the first to write your review' => 'Sea el primero en escribir su reseña',
    'Yes' => 'sí',
    'No' => 'No',
    'Grade' => 'Calificación',
    'OK' => 'OK',
...
',
  ...
  array (
    'Your address is incomplete, please update it.' => 'Su dirección está incompleta, actualícela.',
